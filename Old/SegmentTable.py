...
class Segments(BaseTable):
    ...
    NatureAC = (0x0046, 2, True, 'little', None, -20)
    EffectiveAC = (0x0048, 2, True, 'little', None, -20)
    CrushAC = (0x004A, 2, True, 'little', None, -20)
    MissileAC = (0x004C, 2, True, 'little', None, -20)
    PiercingAC = (0x004E, 2, True, 'little', None, -20)
    SlashingAC = (0x0050, 2, True, 'little', None, -20)
